# 1.5.2
- [D&D 3.5] Fixes bug where character sheet closes automatically when changing values on the sheet. Thanks to [DavidAremaCarretero](https://github.com/DavidAremaCarretero)
